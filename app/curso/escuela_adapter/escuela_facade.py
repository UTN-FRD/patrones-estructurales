from escuela_adapter.curso import Curso
from escuela_adapter.estudiante_regular import EstudianteRegular
from escuela_adapter.profesor import Profesor
...
class EscuelaFacade():
    def __init__(self):
        ...
        self.estudiantes = [EstudianteRegular("Vanesa", 2020), EstudianteRegular("Miguel", 2021), EstudianteRegular("Juana", 2020)]
    ...
    def inscribir_estudiante_en_curso(self, curso_idx, estudiante):
        self.estudiantes.append(estudiante)
        self.cursos[curso_idx].inscribir_estudiante(estudiante)